...
function getBloodPressureValue(BPObservations, typeOfPressure) {
  ...
  console.log(formattedBPObservations[0]['valueQuantity']['value'])
...
client.request("Observation?" + query, {
  ...
  function(ob) {
    ...
    else if(smoke[0]['valueCodeableConcept']['text'] == 'Never smoker' || smoke[0]['valueCodeableConcept']['text'] == 'Unknown if ever smoked'){
      p.smoker = false;
    }
    else{
      p.smoker = true;
